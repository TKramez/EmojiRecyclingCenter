...
class App {
  ...
  genMapLocations() {
    this.emojiPositions = new Array(this.emojiList.length);
    this.emojiList.forEach( (emoji, emojiIndex) => {
  ...
  buildMapImgCanvas() {
    ...
    this.emojiBounds = [];
    for (let emojiIndex = 0; emojiIndex < this.emojiList.length; emojiIndex++) {
  ...
  drawEmojiMap(ctx) {
    ...
    */
    ...
    this.emojiList.forEach( (e, i) => {
      ...
      const x = cx + (width / 2) + (size * 10) * Math.cos(this.emojiPositions[i].a) * this.emojiPositions[i].r;
      const y = cy + (height / 2) + (size * 10) * Math.sin(this.emojiPositions[i].a) * this.emojiPositions[i].r;
  ...
  exportEmojiData() {
    ...
    const startX = 40;
    const startY = 24;
    const scanWidth = canvas.width - 40 * 2;
    const scanHeight = canvas.height - (24 + 246);
    */
